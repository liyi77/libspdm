...
size_t libspdm_internal_ec_get_public_nid_from_x509(const EVP_PKEY *pkey)
{
    int32_t openssl_nid;
    size_t libspdm_nid;

    openssl_nid = EC_GROUP_get_curve_name(EC_KEY_get0_group(EVP_PKEY_get0_EC_KEY(pkey)));
